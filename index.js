...
let array = artists.id;
let index = artists.name;

function getArtistByIndex(array, index) {
  return `The artist at index ${array} is ${index}`;
}

console.log(getArtistByIndex(1, 5));
...
// what if I create a thing to splice out the artists who were active during that time and insert them into a new array that way??????
