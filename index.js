...
// let artGuy = artists.id;
// let index = artists.name;

function getArtistByIndex(arrayArtists, index) {
...
function removeArtist(remove) {
  return artists.splice(remove, 1);
}
...
function addArtist(add) {
  add = {
    ...
    nationality: 'Romania',
    bio:
      "Phil Lisak was born in a swamp and raised like a veal in a box. His earliest recollection of joy was last thursday when he found a $20 bill in a coat pocket he hadn't worn in 3 years. He enjoys all kinds of food, and will likely sit for hours and talk about the way flour used to be milled by hand and oh, have you seen this Chinese lady on Youtube who mills her own flour? She's incredible and I hate her.",
  };
  artists.push(add);
  return artists;
}
